...
<head>
    ...
    <!-- favicon
    ============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="<?= BASEURL; ?>/assets_web/img/pepundan.jpg">
    <!-- Google Fonts
    ============================================ -->
    ...
    <style>
        body{
            background-image: url('https://akcdn.detik.net.id/community/media/visual/2023/04/14/gambar-pemandangan-6_169.jpeg?w=700&q=90');
                            ...
                            <div class="col-lg-4" >
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <a href="../index.php"><img src="<?= BASEURL; ?>/assets_web/img/logo.png" style="width:auto; height:100px" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
